...
inline void perform_newton_cxx( const float re, const float im,
                                const int MAX_ITERS, const int IDX,
...
inline void newton_cxx( const float x_min, const float y_min,
